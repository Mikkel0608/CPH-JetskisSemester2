...
//This array we decided not to use because we made another.
    var orderArray = [];
    order1 = new Class_Order(localStorage.getItem('phone'), localStorage.getItem('amount1'), localStorage.getItem('amount2'), localStorage.getItem('amount3'), localStorage.getItem('orderDay'), localStorage.getItem('orderMonth'), localStorage.getItem('orderYear'), localStorage.getItem('timePeriod'), localStorage.getItem('orderPrice'));
    order2 = new Class_Order('45678904', '1', '1', '1', '03', '3', '2019', '10-12', '1400');
    order3 = new Class_Order('22340987', '2', '3', '1', '12', '7', '2020', '16-18', '2700');
    order4 = new Class_Order('67880322', '3', '1', '2', '24', '12', '2021', '12-14', '2600');
    order5 = new Class_Order('33445522', '2', '1', '3', '15', '5', '2019', '12-14', '2900');
    order6 = new Class_Order('73459025', '1', '3', '3', '21', '9', '2020', '10-12', '3600');
  ...
  var storedOrders = JSON.parse(localStorage.getItem('storedOrders'));
   if (storedOrders == null) {
       storedOrders = [];
       storedOrders.push(new Class_Order('45678904', '1', '1', '1', '03', '3', '2019', '10-12', '1400'));
       storedOrders.push(new Class_Order('22340987', '2', '3', '1', '12', '7', '2020', '16-18', '2700'));
       storedOrders.push(new Class_Order('67880322', '3', '1', '2', '24', '12', '2021', '12-14', '2600'));
       storedOrders.push(new Class_Order('33445522', '2', '1', '3', '15', '5', '2019', '12-14', '2900'));
       storedOrders.push(new Class_Order('73459025', '1', '3', '3', '21', '9', '2020', '10-12', '3600'));
       storedOrders.push(new Class_Order(localStorage.getItem('phone'), orderAmount1JS, orderAmount2JS, orderAmount3JS, document.getElementById('rentDay').value, document.getElementById('rentMonth').value, document.getElementById('rentYear').value, document.getElementById('rentTime').value, finalPrice));
